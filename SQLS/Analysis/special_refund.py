...
SUM(oi.totalPrice+IFNULL(oi.taxFee,0)) AS '退款金额'
FROM SalesOrder AS so FORCE INDEX(platformCustomerIdIndex)
JOIN ops.orderlist AS o ON o.salesOrderId = so.id AND o.type = 2 -- 退款订单
...
AND so.platformCustomerId IN('红尘倚半梦',
'hzhtkj2017',
'tb510575771')
GROUP BY so.id;
'''
...
if __name__ == '__main__':
    platforms = ('100087',)
    print(special_refund_sql.format('2020-01-01','2020-01-02')%("','".join(platforms)))