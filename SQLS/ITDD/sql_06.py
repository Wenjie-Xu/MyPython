...
CASE WHEN ci.city_public_name IS NOT NULL THEN ci.city_tier ELSE '四线以上' END AS '城市等级',
...
LEFT JOIN test.city_info_test AS ci ON ci.city_public_name = LEFT(so.city,2)
